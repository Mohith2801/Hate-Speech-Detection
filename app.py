...
# Check for and download stopwords if they are not already present
try:
    # This line will raise a LookupError if 'stopwords' data is not found
    from nltk.corpus import stopwords
except LookupError:
    # Download the 'stopwords' data if the above line fails
